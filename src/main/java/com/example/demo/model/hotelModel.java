...
public class hotelModel {
	...
	public hotelModel(String nom_hotel, String adr1_hotel, String adr2_hotel, String adr3_hotel, String tel_hotel,
			...
			String ref_hotel, String input_hotel, String cpt_trans_hotel, String email,
			List<utilisateurModel> utilisateurModels, Reservation reservation, List<RoomRack> roomrack) {
		super();
